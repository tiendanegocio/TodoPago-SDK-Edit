...
var stateCodes = require('./stateCodes.json');
...
var endpoint = {
    ...
    developers: 'https://apis.developers.todopago.com.ar/'
}
    ...
    getCredentials: function(email, pass, options, callback) {
        ...
        var req = restClient.post(endpoint[options.endpoint] + 'api/Credentials', args, function(data, response) {
            ...
            if (data.Credentials.resultado.codigoResultado == 0) {
                ...
                this.merchantId = '';
                this.apiKey = '';
                err = 'ERROR : ' + data.Credentials.resultado.codigoResultado + ', message: ' + data.Credentials.resultado.mensajeResultado;
            }
            var credentials = {
